...
export function isLayerEnabled(state, type) {
...
export function tagsForTarget(state, targetType, identity) {
...
export function hasTag(state, targetType, identity, tag) {
...
export function evaluateRules(state, context) {
